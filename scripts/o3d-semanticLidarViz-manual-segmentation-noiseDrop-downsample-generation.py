...
def spawn_vehicle_lidar_camera_segmentation(world, bp, traffic_manager, delta):
    ...
    lidar_low_bp.set_attribute('points_per_second', '375000')  # Menos puntos por segundo
    lidar_low_bp.set_attribute('rotation_frequency', str(1 / delta))
    lidar_low_bp.set_attribute('upper_fov', '30')
    lidar_low_bp.set_attribute('lower_fov', '-45')
    lidar_low_bp.set_attribute('horizontal_fov', '360')
...
def main():
 ...
 # 📌 Crear dos visualizadores SEPARADOS
    ...
    viz_lidar_low.create_window(window_name="Lidar Submuestreo en Generación", width=960, height=540, left=1100, top=100)
