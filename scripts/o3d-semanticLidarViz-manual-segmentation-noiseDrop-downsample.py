...
def main():
 ...
 # 📌 Crear dos visualizadores SEPARADOS
    ...
    for viz in [viz_raw, viz_filtered, viz_downsampled]:
    ...
    # viz_raw.get_render_option().background_color = [0.05, 0.05, 0.05]
    # viz_filtered.get_render_option().background_color = [0.05, 0.05, 0.05]
    # viz_downsampled.get_render_option().background_color = [0.05, 0.05, 0.05]

    # viz_raw.get_render_option().point_size = 1.35
    # viz_filtered.get_render_option().point_size = 1.35
    # viz_downsampled.get_render_option().point_size = 1.35

    # viz_raw.get_render_option().show_coordinate_frame = True
    # viz_filtered.get_render_option().show_coordinate_frame = True
    # viz_downsampled.get_render_option().show_coordinate_frame = True
    ...
    while True:
        ...
        if not viz_filtered.poll_events() or not viz_raw.poll_events() or not viz_downsampled.poll_events():
