...
Finalmente, el *ontology.json* contiene el diccionario de las clases que se usan, en este caso de [CARLA](https://carla.readthedocs.io/en/latest/ref_sensors/#:~:text=0.9.13%20to%200.9.14)%3A-,Value,-Tag), con el nombre, el índice y su valor RGB.
